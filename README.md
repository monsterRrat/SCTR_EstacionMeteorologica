...
Este es un proyecto basado en una Raspberry Pi Pico (RP2040), un microcontrolador con 2MB de memoria sin acceso wifi y que a mayores cuenta con varias piezas de hardware:
- Sensor DHT20: un sensor para tomar medidas de humedad y temperatura
- Sensor SPG30: un sensor para tomar medias de calidad de aire y cantidad de CO2 en el ambiente
...
- Museos, para controlar valores elevados de humedad o CO2 que pueden poner en peligro la conservación de las obras de arte.
